...
namespace MottuApi.Models
{
    ...
    public class Moto
    {
        ...
        [SwaggerSchema("Status atual da moto", Example = "Disponível, Alugada ou Manutenção")]
        public StatusMoto Status { get; set; } = StatusMoto.Disponível; 

        [Required(ErrorMessage = "O setor de conservação é obrigatório.")]
        [SwaggerSchema("Setor de conservação da moto", Example = "Bom, Intermediário ou Ruim")]
        ...
        [SwaggerSchema("Pátio onde a moto está alocada", Example = "Pátio Centro")]
