...
namespace MottuApi.DTOs
{
    public class ClienteDto
    {
        ...
        [SwaggerSchema(Description = "Nome de usuário único do cliente", Example = "joao_silva")]
        ...
        [SwaggerSchema(Description = "Nome completo do cliente", Example = "Michelle Marques")]
        public string Nome { get; set; } = string.Empty;

        [Required(ErrorMessage = "A senha do cliente é obrigatória.")]
        [StringLength(100, MinimumLength = 6, ErrorMessage = "A senha deve ter no mínimo 6 caracteres.")]
        [SwaggerSchema(Description = "Senha do cliente (mínimo 6 caracteres)", Example = "senha123")]
        public string Senha { get; set; } = string.Empty;

        [SwaggerSchema(Description = "Placa da moto associada ao cliente (opcional)", Example = "ABC-1234")]
